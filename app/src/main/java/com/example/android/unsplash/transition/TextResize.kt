...
class TextResize : Transition {
    ...
    override fun createAnimator(sceneRoot: ViewGroup, startValues: TransitionValues?,
        ...
        val rightProp = PropertyValuesHolder.ofFloat("right",
                startData.width.toFloat() - startData.paddingRight.toFloat(), endData.width.toFloat() - endData.paddingRight.toFloat())
        val bottomProp = PropertyValuesHolder.ofFloat("bottom",
                startData.height.toFloat() - startData.paddingBottom.toFloat(), endData.height.toFloat() - endData.paddingBottom.toFloat())
    ...
    internal class TextResizeData(textView: TextView) {
        ...
        init {
            this.paddingLeft = textView.paddingLeft
            this.paddingTop = textView.paddingTop
            this.paddingRight = textView.paddingRight
            this.paddingBottom = textView.paddingBottom
            this.width = textView.width
            this.height = textView.height
            this.gravity = textView.gravity
            this.textColor = textView.currentTextColor
        }
    }
